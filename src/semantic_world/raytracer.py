...
class RayTracer:
        ...
        for body in bodies_to_add:
            for i, collision in enumerate(body.collision):
                self.scene.add_geometry(
                    ...
                    transform=self.world.compute_forward_kinematics_np(self.world.root, body)
    ...
    def create_depth_map(self, camera_position: NpMatrix4x4, resolution: int = 512) -> np.ndarray:
        """

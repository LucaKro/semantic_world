...
class Expression(Symbol_):
    ...
    def __add__(
        self,
        other: Union[Symbol, Expression, float, TransformationMatrix, RotationMatrix, Quaternion],
    ) -> Expression: ...
    def __radd__(self, other: float) -> Expression: ...
    @overload
    def __sub__(self, other: Point3) -> Point3: ...
    ...
    def __mul__(
        self,
        other: Union[Symbol, Expression, float, RotationMatrix, TransformationMatrix, Quaternion],
    ) -> Expression: ...
    def __rmul__(self, other: float) -> Expression: ...
    @overload
    def __truediv__(self, other: Point3) -> Point3: ...
...
class Point3(Symbol_, ReferenceFrameMixin):
    ...
    def from_iterable(
        cls,
        data: Optional[
            Union[Expression, Point3, Vector3, ca.SX, np.ndarray, Iterable[symbol_expr_float]]
        ] = None,
        reference_frame: Optional[KinematicStructureEntity] = None,
    ) -> Point3: ...
...
class RotationMatrix(Symbol_, ReferenceFrameMixin):
    ...
    @overload
    def from_vectors(
        cls, x: Vector3, y: Vector3, reference_frame: Optional[KinematicStructureEntity] = None
    ) -> RotationMatrix: ...
    @classmethod
    @overload
    def from_vectors(
        cls, x: Vector3, z: Vector3, reference_frame: Optional[KinematicStructureEntity] = None
    ) -> RotationMatrix: ...
    @classmethod
    @overload
    def from_vectors(
        cls, y: Vector3, z: Vector3, reference_frame: Optional[KinematicStructureEntity] = None
    ) -> RotationMatrix: ...
    @classmethod
    @overload
    def from_vectors(
    ...
    def from_iterable(
        ...
        data: Optional[
            Union[
                ...
                Quaternion,
                ca.SX,
                Tuple[symbol_expr_float, symbol_expr_float, symbol_expr_float, symbol_expr_float],
            ]
        ] = None,
        reference_frame: Optional[KinematicStructureEntity] = None,
    ) -> Quaternion: ...
...
def compile_and_execute(
    f: Callable[..., all_expressions], params: Union[List[Union[float, np.ndarray]], np.ndarray]
...
@overload
def if_else(
    condition: symbol_expr_float, if_result: symbol_expr_float, else_result: symbol_expr_float
) -> Expression: ...
@overload
def if_greater(
...
@overload
def if_less(
    a: symbol_expr_float, b: symbol_expr_float, if_result: Quaternion, else_result: Quaternion
) -> Quaternion: ...
@overload
def if_less(
    a: symbol_expr_float, b: symbol_expr_float, if_result: Vector3, else_result: Vector3
...
@overload
def if_eq_zero(condition: symbol_expr_float, if_result: Point3, else_result: Point3) -> Point3: ...
@overload
def if_eq_zero(
    condition: symbol_expr_float, if_result: symbol_expr_float, else_result: symbol_expr_float
) -> Expression: ...
...
def if_cases(
    cases: Sequence[Tuple[symbol_expr_float, symbol_expr_float]], else_result: symbol_expr_float
) -> Expression: ...
...
def project_to_plane(
    frame_V_plane_vector1: Vector3, frame_V_plane_vector2: Vector3, frame_P_point: Point3
) -> Point3: ...
...
def total_derivative(
    expr: Union[Symbol, Expression], symbols: Iterable[Symbol], symbols_dot: Iterable[Symbol]
) -> Expression: ...

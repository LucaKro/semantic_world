...
class WallDAO(ViewDAO, DataAccessObject[semantic_world.views.views.Wall]):
    ...
    adjacent_rooms: Mapped[List[RoomDAO]] = relationship('RoomDAO', foreign_keys='[RoomDAO.walldao_adjacent_rooms_id]', post_update=True)
...
class RoomDAO(SupportingSurfaceDAO, DataAccessObject[semantic_world.views.views.Room]):
    ...
    walldao_adjacent_rooms_id: Mapped[Optional[int]] = mapped_column(ForeignKey('WallDAO.id', use_alter=True), nullable=True)

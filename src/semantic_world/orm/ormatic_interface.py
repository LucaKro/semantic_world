...
class ShapeDAO(Base, DataAccessObject[semantic_world.geometry.Shape]):
    ...
    origin: Mapped[TransformationMatrixMappingDAO] = relationship(
        "TransformationMatrixMappingDAO", uselist=False, foreign_keys=[origin_id], post_update=True
    )
...
class TransformationMatrixMappingDAO(
    ...
    rotation: Mapped[QuaternionMappingDAO] = relationship(
        "QuaternionMappingDAO", uselist=False, foreign_keys=[rotation_id], post_update=True
    )
    reference_frame: Mapped[BodyDAO] = relationship(
        "BodyDAO", uselist=False, foreign_keys=[reference_frame_id], post_update=True
    )
...
class HasDrawersDAO(Base, DataAccessObject[semantic_world.views.views.HasDrawers]):
    ...
    drawers: Mapped[List[DrawerDAO]] = relationship(
        "DrawerDAO", foreign_keys="[DrawerDAO.hasdrawersdao_drawers_id]", post_update=True
    )
...
class OmniDriveDAO(ActiveConnectionDAO, DataAccessObject[semantic_world.connections.OmniDrive]):
    ...
    x: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[x_id], post_update=True
    )
    y: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[y_id], post_update=True
    )
    z: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[z_id], post_update=True
    )
    roll: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[roll_id], post_update=True
    )
    pitch: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[pitch_id], post_update=True
    )
    yaw: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[yaw_id], post_update=True
    )
    x_vel: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[x_vel_id], post_update=True
    )
    y_vel: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[y_vel_id], post_update=True
    )
...
class PrismaticConnectionDAO(
    ActiveConnectionDAO, DataAccessObject[semantic_world.connections.PrismaticConnection]
):
    ...
    dof: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[dof_id], post_update=True
    )
...
class RevoluteConnectionDAO(
    ActiveConnectionDAO, DataAccessObject[semantic_world.connections.RevoluteConnection]
):
...
class Connection6DoFDAO(
    ...
    qx: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[qx_id], post_update=True
    )
    qy: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[qy_id], post_update=True
    )
    qz: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[qz_id], post_update=True
    )
    qw: Mapped[DegreeOfFreedomMappingDAO] = relationship(
        "DegreeOfFreedomMappingDAO", uselist=False, foreign_keys=[qw_id], post_update=True
    )

...
def test_compute_chain_of_bodies_pr2(pr2_world):
    ...
    assert real == [
        PrefixedName(name="base_footprint", prefix="pr2_kinematic_tree"),
...
def test_compute_chain_of_connections_pr2(pr2_world):
    ...
    assert real == [
        ...
        PrefixedName(
            name="r_shoulder_pan_link_T_r_shoulder_lift_link", prefix="pr2_kinematic_tree"
        ),
        PrefixedName(
            name="r_shoulder_lift_link_T_r_upper_arm_roll_link", prefix="pr2_kinematic_tree"
        ),
        ...
        PrefixedName(
            name="r_gripper_palm_link_T_r_gripper_tool_frame", prefix="pr2_kinematic_tree"
        ),
    ]
...
def test_compute_split_chain_of_bodies_pr2(pr2_world):
    ...
    chain1, connection, chain2 = pr2_world.compute_split_chain_of_kinematic_structure_entities(
        root, tip
    )
...
def test_get_split_chain_pr2(pr2_world):
    ...
    chain2 = [n.name.name for n in chain2]
    assert chain1 == [
        "l_gripper_r_finger_link_T_l_gripper_r_finger_tip_link",
        "l_gripper_palm_link_T_l_gripper_r_finger_link",
    ]
    assert chain2 == [
        "l_gripper_palm_link_T_l_gripper_l_finger_link",
